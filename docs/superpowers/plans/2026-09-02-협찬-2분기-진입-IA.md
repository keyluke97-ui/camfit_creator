...
Expected: 마지막 줄에 `N passed, 0 failed` (기존 케이스 수 + 11)
...
import { resolveApplyTrack, resolveOfferTrack } from '@/lib/sponsorshipTrackRules';
import type { OfferTrackDestination } from '@/lib/sponsorshipTrackRules';
import type { ReviewStatus } from '@/types';
...
export default function SponsorshipTracks({
    ...
    const offer = resolveOfferTrack({ reviewStatus, isPublic, offerCount, newOfferCount });
...
| 승인 + 공개 + 제안 N건 | 새 제안 N | 받은 제안 N건 · 기한 안에 회신해주세요 |
